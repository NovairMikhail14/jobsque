...
class JobCompanyView extends StatefulWidget {
  const JobCompanyView({Key? key}) : super(key: key);

  @override
  State<JobCompanyView> createState() => _JobCompanyViewState();
}

class _JobCompanyViewState extends State<JobCompanyView> {
