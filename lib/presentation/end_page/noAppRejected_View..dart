...
class NoAppRejectedView extends StatefulWidget {
  const NoAppRejectedView({Key? key}) : super(key: key);

  @override
  State<NoAppRejectedView> createState() => _NoAppRejectedViewState();
}

class _NoAppRejectedViewState extends State<NoAppRejectedView> {
        ...
        body: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SvgPicture.asset(ImageAssets.appRejected),
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    AppStrings.taskNoAppRejectsTitle,
                  ...
                  Text(
                    AppStrings.taskNoAppRejectsBody,
