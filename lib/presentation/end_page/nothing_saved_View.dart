...
class NothingSavedView extends StatefulWidget {
  const NothingSavedView({Key? key}) : super(key: key);

  @override
  State<NothingSavedView> createState() => _NothingSavedViewState();
}

class _NothingSavedViewState extends State<NothingSavedView> {
        ...
        body: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SvgPicture.asset(ImageAssets.nothingSaved),
            Container(
